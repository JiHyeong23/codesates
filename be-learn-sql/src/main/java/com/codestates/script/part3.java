...
public class part3 {
  ...
  */
  public static final String PART3_2_5 = "SELECT title FROM content WHERE content.userId = (SELECT id FROM user WHERE name = 'minsanggu');";

  /*
  ----------------------------------------------------------------------------------------------
      TODO: Q 3-2-6. minsanggu이 작성한 content의 category name을 찾기위한 SQL을 작성해주세요.
  */
  public static final String PART3_2_6 = "SELECT category.name FROM category JOIN content_category ON category.id = content_category.categoryId " +
                  "JOIN content ON content_category.contentId = content.id JOIN user ON content.userId = user.id " +
  ...
  */
  public static final String PART3_2_7 = "SELECT content.title, content.body, content.created_at FROM content " +
  ...
  */
  public static final String PART3_2_8 = "SELECT content.title, content.body, content.created_at, user.name FROM user " +
  ...
  */
  public static final String PART3_2_9 = "SELECT COUNT(*) AS ContentCount FROM content JOIN user ON content.userId = user.id " +
  ...
  */
  public static final String PART3_2_10 =
          "SELECT user.name AS name, COUNT(content.userId) AS ContentCount FROM user LEFT JOIN content ON user.id = content.userId GROUP BY user.name;";
}
